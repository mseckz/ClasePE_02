...
public class JpaTest {
	...
	private void modificarDepartamentoId1() {
		Departamento dept = manager.find(Departamento.class, new Long(1));
		//Departamento dept = manager.createQuery("Select d from Departamento d where id = 1", Departamento.class).getSingleResult();
